...
class PaymentPolicy
{
    ...
    {
        return $user->can('payment.view') && ($this->isInternal($user) || $user->company_id === $payment->company_id);
    }
    ...
    {
        return $user->hasRole('company_owner') && $user->company_id === $payment->company_id;
    }
