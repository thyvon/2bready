...
class PackageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $packages = [
            ['name' => 'Compliance Readiness', 'name_kh' => null, 'description' => 'Authoritative legal and tax structuring.', 'tier' => Tier::Free, 'level_code' => 'L1', 'sort_order' => 1, 'prices' => ['monthly' => 0, 'yearly' => 0]],
