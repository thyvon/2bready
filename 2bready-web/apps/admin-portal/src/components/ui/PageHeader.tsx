...
export default function PageHeader({ title, action }: PageHeaderProps) {
  ...
  // useNavItems() always returns at least the role's dashboard root as item 0
  // (see nav-items.tsx) — never empty, so root is always defined here.
  ...
  // Every page already provides a human-readable title (e.g. "Company Profile",
  // "Set up your company") — reused here as the trail's final, non-clickable
  // crumb instead of asking every one of PageHeader's ~8 call sites to also
  // supply a separate breadcrumb label.
