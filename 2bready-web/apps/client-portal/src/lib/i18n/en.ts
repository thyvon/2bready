const en = {
  ...
  'settings.profile_name_label': 'Full Name',
  'settings.profile_email_label': 'Email Address',
  'settings.profile_save': 'Save Changes',
  'settings.profile_saved': 'Profile updated successfully.',
  'settings.profile_save_error': 'Could not update profile.',
  'settings.password_title': 'Change Password',
  'settings.password_current_label': 'Current Password',
  'settings.password_new_label': 'New Password',
  'settings.password_confirm_label': 'Confirm New Password',
  'settings.password_save': 'Update Password',
  'settings.password_saved': 'Password changed successfully. Please log in again.',
  'settings.password_save_error': 'Could not change password.',
  'settings.password_wrong_current': 'Current password is incorrect.',
  'settings.company_title': 'Company Profile',
  'settings.company_name_label': 'Company Name',
  'settings.company_name_kh_label': 'Company Name (Khmer)',
  'settings.company_registration_no_label': 'Business Registration No.',
  'settings.company_industry_label': 'Industry',
  'settings.company_country_label': 'Country',
  'settings.company_compliance_start_date': 'Compliance Start Date',
  'settings.company_compliance_start_date_helper': 'Optional — when your actual compliance obligations began.',
  'settings.company_default_locale_label': 'Default Language',
  'settings.company_save': 'Save Changes',
  'settings.company_saved': 'Company profile updated successfully.',
  'settings.company_save_error': 'Could not update company profile.',
  'settings.company_info_locked': 'Industry and country cannot be changed while an active journey or subscription exists.',
  ...
  'notification_preferences.type': 'Type',
  ...
  'notification_preferences.save_error': 'Could not save preferences.',
  'notification_preferences.type_payment_confirmed': 'Payment Confirmed',
  'notification_preferences.type_payment_rejected': 'Payment Rejected',
  'notification_preferences.type_audit_approved': 'Audit Approved',
  'notification_preferences.type_document_verified': 'Document Verified',
  'notification_preferences.type_document_expired': 'Document Expired',
  'notification_preferences.type_subscription_cancelled': 'Subscription Cancelled',
  ...
  'company.name_kh_label': 'Company Name (Khmer)',
  'company.registration_no_label': 'Business Registration No.',
  ...
  'sop.acknowledgments_title': 'Your acknowledgments',
  'sop.acknowledgments_subtitle': 'Procedures assigned to you — read each one and acknowledge to confirm your team follows it.',
  'sop.pending': 'Pending',
  'sop.acknowledged': 'Acknowledged',
  'sop.acknowledge': 'Acknowledge',
  'sop.ack_success': 'Acknowledgment recorded.',
  'sop.acknowledged_at': 'Acknowledged {date}',
  'sop.sent_by': 'Sent by {name}',
  'sop.no_assignments': 'Nothing to acknowledge',
  'sop.no_assignments_desc': 'When a procedure is sent to you for sign-off, it appears here.',
  'sop.manage_signoffs': 'Sign-offs',
  'sop.track_title': 'Employee sign-offs — {title}',
  'sop.track_empty': 'No employees assigned yet. Select colleagues below and send for acknowledgment.',
  'sop.select_employees': 'Assign employees',
  'sop.send': 'Send for sign-off',
  ...
  'billing.payment_detail_title': 'Payment Details',
  'billing.payment_detail_reference': 'Reference',
  ...
  'billing.payment_detail_confirmed': 'Confirmed',
  'billing.payment_detail_bank': 'Bank Transfer Details',
  'billing.payment_detail_close': 'Close',
  'billing.btn_view': 'View',
